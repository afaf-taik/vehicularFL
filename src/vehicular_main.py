...
plt.ylim(ymin=0.5)
plt.plot(range(int(len(moy_rnd_acc[:30]))), moy_rnd_acc[:30], 'b+',  linewidth=1, linestyle='-', label='random')
plt.plot(range(int(len(moy_opt_acc[:30]))), moy_opt_acc[:30], 'ro',  linewidth=1, linestyle='-', label = 'proposed')
plt.grid()
