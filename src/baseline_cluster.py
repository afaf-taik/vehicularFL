...
from utils import get_dataset, average_weights, exp_details, models_similarity, flip_labels_clusters
...
for i in range (tries):
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        if(epoch==test_time):    
            ...
            #SpectralClustering(2).fit_predict(similarity)
            Z = hcl.linkage(squareform(similarity))
            print(Z)
            clusters = hcl.fcluster(Z,t=4,criterion='maxclust')
            print('here are the clusters', clusters)
